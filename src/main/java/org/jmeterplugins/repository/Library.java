...
public class Library {
  ...
  public static final Comparator<Library> versionComparator =
      new Comparator<Library>() {
        ...
        public int compare(Library lib1, Library lib2) {
          ...
          for (int i = 0; i < length; i++) {
            try {
              code = Integer.compare(Integer.parseInt(versions1[i]),
                                     Integer.parseInt(versions2[i]));
  ...
  public static class InstallationInfo {
    ...
    public InstallationInfo(String name, String tmpPath,
