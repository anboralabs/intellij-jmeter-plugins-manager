...
public class JARSourceFilesystem extends JARSource {
  private static final Logger log =
      LoggerFactory.getLogger(JARSourceFilesystem.class);
  ...
  public JSON getRepo() throws IOException {
    return JSONSerializer.toJSON(FileUtils.readFileToString(jsonFile),
                                 new JsonConfig());
  }
  ...
  @Override
  public DownloadResult getJAR(String id, String location,
